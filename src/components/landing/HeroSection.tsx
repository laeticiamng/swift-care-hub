...
export function HeroSection() {
  ...
  return <header className="relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center px-6 pt-28 pb-24 relative">
        ...
        <p className="mt-4 text-lg sm:text-xl text-muted-foreground max-w-2xl leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 mx-[100px] pl-0 px-[10px]">Un clic. Une action. Zéro formation. Interfaces pensées pour les gardes</p>
...
Une pancarte IDE en un écran</p>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Button size="lg" variant="outline" className="px-8 h-12 text-base animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500" onClick={() => document.getElementById('problem')?.scrollIntoView({
          behavior: 'smooth'
        })}>
            Découvrir
          </Button>
