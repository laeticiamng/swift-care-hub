...
export function HeroSection() {
  ...
  return <header className="relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center px-6 pt-28 pb-24 relative">
        ...
        <p className="mt-4 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">Un clic. Un action. Zéro formation. Interfaces pensées pour les gardes</p>
