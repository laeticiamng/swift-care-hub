  ...
  return (
    <Section className="py-10 sm:py-16 px-4 sm:px-6 bg-card border-y">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Chaque mois sans changement coûte en temps soignant, en risques de sécurité et en opportunités manquées. L'essai de 10 semaines n'est pas un engagement irréversible : c'est un test cadré, avec des critères de réussite définis à l'avance.
        </motion.p>
      </div>
    </Section>
  );
