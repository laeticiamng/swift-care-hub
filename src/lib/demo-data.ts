...
export const DEMO_ENCOUNTERS: DemoEncounter[] = [
  ...
  { id: 'demo-e3', patient_id: 'demo-p3', status: 'in-progress', zone: 'sau', box_number: 2, ccmu: 2, cimu: 2, motif_sfmu: 'Dyspnée', medecin_id: 'demo-medecin', arrival_time: hoursAgo(3), triage_time: hoursAgo(2.83), patients: { nom: 'BERNARD', prenom: 'Sophie', date_naissance: '1981-11-08', sexe: 'F', allergies: [] } },
  ...
  { id: 'demo-e6', patient_id: 'demo-p6', status: 'triaged', zone: 'sau', box_number: 6, ccmu: 3, cimu: 3, motif_sfmu: 'Céphalée', medecin_id: null, arrival_time: hoursAgo(1), triage_time: minsAgo(50), patients: { nom: 'MOREAU', prenom: 'Camille', date_naissance: '1975-09-18', sexe: 'F', allergies: [] } },
  ...
  { id: 'demo-e8', patient_id: 'demo-p8', status: 'in-progress', zone: 'uhcd', box_number: 2, ccmu: 4, cimu: 4, motif_sfmu: 'AEG / Fièvre', medecin_id: 'demo-medecin', arrival_time: hoursAgo(6), triage_time: hoursAgo(5.83), patients: { nom: 'LAURENT', prenom: 'Emilie', date_naissance: '1965-06-03', sexe: 'F', allergies: ['Penicilline', 'Sulfamides'] } },
